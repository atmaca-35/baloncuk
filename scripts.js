document.addEventListener('DOMContentLoaded', async () => {
    ...
    const clickableWords = {
        '+k': ['<p class='purple'>geçişsiz eylem</p> yan- ', '<p class='purple'>ad</p> yanık'],
    ...
    function createClickableWords() {
        Object.keys(clickableWords).forEach(word => {
            ...
            resultDiv.innerHTML = resultDiv.innerHTML.replace(regex, `<span class="clickable-word" style="color: green; cursor: pointer;">$1</span>`);
        });
